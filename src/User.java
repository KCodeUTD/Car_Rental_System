...
public class User  implements Comparable<User>{
	...
	public static void register(GenericMyHashMap<String,User> u) {
		int total = u.size();
		System.out.println("Welcome to Rent-N-GO! Here we'll have you register your account\nPlease input a username: ");
		Scanner userID = new Scanner(System.in);
		String username = userID.nextLine();
		System.out.println("Please assign a password to your account.");
	...
	public static User login(GenericMyHashMap<String,User> u) {
		...
		if(u.containsKey(temp.getID()) != true) {
			...
			if(u.get(username).getPw().contains(password)) {
